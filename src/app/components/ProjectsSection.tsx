  ...
  software: [
    {
      ...
      links: [
        { label: "GitHub", url: "https://github.com/lucasnbll", type: "github" },
        { label: "Live Demo", url: "#contact", type: "live" },
      ],
      featured: true,
      color: "#1E3A8A",
    },
  ...
  data: [
    {
      ...
      links: [{ label: "Live Demo", url: "#contact", type: "live" }],
      featured: true,
      color: "#8B5CF6",
    },
    {
  ...
  branding: [
    {
      ...
      links: [{ label: "View Case Study", url: "#contact", type: "live" }],
      featured: true,
      color: "#F59E0B",
    },
  ],
